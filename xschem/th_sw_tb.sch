...
exit 1  
.endc  "}
C {devices/vsource.sym} 720 -220 0 0 {name=VCLK value="PULSE(0 1.8 10n 50p 50p 5u 10u)" savecurrent=false}
...
C {devices/vsource.sym} 720 -90 0 0 {name=VCLK1 value="PULSE(1.8 0 10n 50p 50p 5u 10u)" savecurrent=false}
...
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 890 -300 2 0 {name=p10 sig_type=std_logic lab=VSSA}
