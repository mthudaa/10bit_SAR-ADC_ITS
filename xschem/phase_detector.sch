...
N 540 -520 780 -640 {lab=OUTP}
N 520 -640 760 -520 {lab=OUTN}
...
C {devices/ipin.sym} 120 -720 0 0 {name=p7 sig_type=std_logic lab=VDD}
...
C {devices/ipin.sym} 120 -700 0 0 {name=p10 sig_type=std_logic lab=VSS}
C {devices/opin.sym} 100 -600 0 0 {name=p13 sig_type=std_logic lab=OUTP}
