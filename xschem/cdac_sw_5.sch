...
C {tg_sw_5.sym} 470 -50 0 0 {name=x4}
...
C {devices/lab_wire.sym} 620 -80 0 1 {name=p29 sig_type=std_logic lab=vcm}
C {tg_sw_5.sym} 860 -50 0 0 {name=x5}
C {devices/lab_wire.sym} 710 -80 0 0 {name=p30 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 710 -20 0 0 {name=p31 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 710 -60 0 0 {name=p32 sig_type=std_logic lab=clk1}
C {devices/lab_wire.sym} 710 -40 0 0 {name=p33 sig_type=std_logic lab=clkb1}
C {devices/lab_wire.sym} 1010 -80 0 1 {name=p34 sig_type=std_logic lab=dac_out}
