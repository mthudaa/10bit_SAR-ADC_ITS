...
C {devices/vsource.sym} 200 -260 0 0 {name=VSS1 value="SIN(0 0.9 19.1556490k)" savecurrent=false}
C {devices/vsource.sym} 320 -260 0 0 {name=VSS2 value="SIN(0 -0.9 19.1556490k)" savecurrent=false}
...
global netlist_dir .  
set wr_singlescale  
tran 10n 5350u  ; Mengubah start time menjadi 1n  
remzerovec 
write th_tb.raw
wrdata th_tb.txt CLK CLKB VIP VIN VCP VCN 
quit 0
.endc  "}
C {devices/vsource.sym} 640 -250 0 0 {name=VCLK value="PULSE(0 1.8 0 50p 50p 2600n 5200n)" savecurrent=false}
...
C {devices/vsource.sym} 640 -130 0 0 {name=VDA1 value="PULSE(1.8 0 0 50p 50p 2600n 5200n)" savecurrent=false}
