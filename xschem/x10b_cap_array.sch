...
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -990 0 0 {name=C3 model=cap_mim_m3_1 W=4 L=4 MF=128 spiceprefix=X}
C {devices/lab_wire.sym} 420 -910 0 1 {name=p33 sig_type=std_logic lab=vc}
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -880 0 0 {name=C4 model=cap_mim_m3_1 W=4 L=4 MF=64 spiceprefix=X}
C {devices/lab_wire.sym} 420 -800 0 1 {name=p34 sig_type=std_logic lab=vc}
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -770 0 0 {name=C5 model=cap_mim_m3_1 W=4 L=4 MF=32 spiceprefix=X}
C {devices/lab_wire.sym} 420 -690 0 1 {name=p35 sig_type=std_logic lab=vc}
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -660 0 0 {name=C6 model=cap_mim_m3_1 W=4 L=4 MF=16 spiceprefix=X}
C {devices/lab_wire.sym} 420 -580 0 1 {name=p36 sig_type=std_logic lab=vc}
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -550 0 0 {name=C7 model=cap_mim_m3_1 W=4 L=4 MF=8 spiceprefix=X}
C {devices/lab_wire.sym} 420 -470 0 1 {name=p37 sig_type=std_logic lab=vc}
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -440 0 0 {name=C8 model=cap_mim_m3_1 W=4 L=4 MF=4 spiceprefix=X}
C {devices/lab_wire.sym} 420 -360 0 1 {name=p38 sig_type=std_logic lab=vc}
C {sky130_fd_pr/cap_mim_m3_1.sym} 420 -330 0 0 {name=C9 model=cap_mim_m3_1 W=4 L=4 MF=2 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 630 -120 0 0 {name=C12 model=cap_mim_m3_1 W=4 L=4 MF=64 spiceprefix=X}
